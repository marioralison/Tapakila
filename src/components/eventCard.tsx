...
export default function EventCard({
  ...
  return (
    <div className="w-120 h-55 bg-white flex justify-center items-start rounded-xl relative border border-zinc-100 shadow-md hover:shadow-xl cursor-pointer transition delay-180 duration-180 ease-in-out hover:-translate-y-1 hover:scale-102">
